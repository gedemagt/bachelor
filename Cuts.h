...
public:
	...
	virtual ~Cuts();
	virtual void add1DCut(Cut* tcut, const char* name, Int_t nbinsx, Double_t xlow, Double_t xup);
	virtual void add2DCut(Cut* tcut, const char* name, Int_t nbinsx, Double_t xlow, Double_t xup, Int_t nbinsy, Double_t ylow, Double_t yup);
	virtual void add1DCut(Cut* tcut, const char* name);
	virtual void add2DCut(Cut* tcut, const char* name);
	...
	virtual void writeToFile(TFile *f);
private:
